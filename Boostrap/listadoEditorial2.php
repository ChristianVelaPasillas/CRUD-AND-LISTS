...
<div class = "container">
  ...
  <a href="agregarEditorial2.php" class= "btn btn-outline-success" > Agregar</a>   
  ...
  <tbody>
              <?php
                while($row = mysqli_fetch_array($result)){
                  ...
                  echo '<td>'.$row['nota'].'</td>';
                  echo '<td>'.'<a href="modificarTitulo.php?id_titulos='.$row['id_titulos'].'" class="btn btn-primary">Modificar</a>'.'</td>';
                  echo '<td>'.'<a href="borrarTitulo.php?id_titulos='.$row['id_titulos'].'" class="btn btn-danger">Borrar</a>'.'</td>';
                  echo '<td>'.'<a href="consultarTitulo.php?id_titulos='.$row['id_titulos'].'" class="btn btn-success">Consultar</a>'.'</td>';
                  echo '</tr>';
                }
              ?>
  </tbody>
