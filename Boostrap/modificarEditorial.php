...
<form action="actualizarEditorial.php" method= "POST">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name = "nombre" placeholder = "Tecle el nombre de la editorial" required value = "<?php echo $row['nombre_editorial']; ?>" >
...
<div class = "col-md-8">
  <div class="form-group">
    ...
    <input type="text" class="form-control" name = "ciudad" placeholder = "Teclea la ciudad" required value = "<?php echo $row['ciudad']; ?>" >
  </div>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name = "estado" placeholder = "Teclea las 2 iniciales del estado" required value = "<?php echo $row['estado']; ?>" >
  </div>
...
<input type= "submit" name = "Agregar"  value = "Agregar" class="btn btn-primary btn-block" > </div>
