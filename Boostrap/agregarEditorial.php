...
<div class = "container">
  ...
  <h1> Agregar una nueva editorial</h1>
...
<form action="guardarEditorial.php" method= "POST">
  <div class="form-group">
    <label for="nombre">Editorial Name</label>
    <input type="text" class="form-control" name = "nombre" placeholder = "Tecle alenombre de la editorial" required>
...
<div class = "col-md-8">
  <div class="form-group">
    ...
    <input type="text" class="form-control" name = "ciudad" placeholder = "Teclea la ciudad" required>
  </div>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name = "estado" placeholder = "Teclea las 2 iniciales del estado" required>
  </div>
...
<input type= "submit" name = "Agregar" class="btn btn-primary btn-block" > </div>
